...
public class Rotate extends JPanel {
	...
	private static final String author = "<Your Name>";		// type in your name here
	...
	public Rotate() {
        ...
        speedTestButton.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
            	...
            	statusLine.setText("Speed test: " + cnt + " rotations in " + time + " ms");
        		angle = lastAngle;
        	}        	
        });
	...
	private void initDstView() {
		// calculate destination size large enough to embed rotated image at any angle
		
		/**** TODO: calculate correct size of destination view based on size of source view ****/
		int width = srcView.getImgWidth() + 50;		// replace by your own calculation
		int height =  srcView.getImgHeight() + 50;	// replace by your own calculation
		/***************************************************************************************/
    ...
    protected void rotateImage(boolean silent) {
    	...
    	case 0:	// Nearest Neigbour
    		rotateNearestNeigbour(srcPixels, srcWidth, srcHeight, dstPixels, dstWidth, dstHeight);
    		break;
    	case 1:	// Bilinear Interpolation
    		rotateBilinear(srcPixels, srcWidth, srcHeight, dstPixels, dstWidth, dstHeight);
    		break;
    	}
     ...
     */
    void rotateNearestNeigbour(int srcPixels[], int srcWidth, int srcHeight, int dstPixels[], int dstWidth, int dstHeight) {
     ...
     * @param dstHeight - destination image height
     */
    void rotateBilinear(int srcPixels[], int srcWidth, int srcHeight, int dstPixels[], int dstWidth, int dstHeight) {
